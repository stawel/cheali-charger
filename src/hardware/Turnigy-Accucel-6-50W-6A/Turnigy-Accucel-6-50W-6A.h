...
#define MAX_DISCHARGE_P         ANALOG_WATT(25.000)                //5W  //replaced resistor
#define MAX_DISCHARGE_I         ANALOG_AMP(5.000)   //should be 1A      //replaced resistor (need more cooling)
