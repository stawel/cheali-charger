...
#define ENABLE_TX_HW_SERIAL_PIN7_PIN38   // if set, need to adjust TX_HW_SERIAL_PIN in imaxB6-pins.h
...
#define ANALOG_INPUTS_ADC_BURST_COUNT           80
#define ANALOG_INPUTS_ADC_ROUND_MAX_COUNT       16
