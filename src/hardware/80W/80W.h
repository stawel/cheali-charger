...
#define MAX_CHARGE_I            ANALOG_AMP(7.005)
#define MAX_CHARGE_P            ANALOG_WATT(80.005)

#define MAX_DISCHARGE_P         ANALOG_WATT(5.005)
#define MAX_DISCHARGE_I         ANALOG_AMP(1.005)
