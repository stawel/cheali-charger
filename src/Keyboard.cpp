...
static const prog_uint16_t speedTable[]  PROGMEM = {1, 2, 4, 16, 64, 256, 1024, 4096};// 16384, 65535};
static const prog_uint16_t thisSpeedT[]  PROGMEM = {1, 3, 8,  7,  7,   7,    7,    7};//,     7,     7};
static const prog_uint16_t speedFactor[] PROGMEM = {1, 1, 1,  1,  1,   1,    4,   16};//,    64,   256};
