...
#define CHEALI_CHARGER_EEPROM_CALIBRATION_VERSION       52
#define CHEALI_CHARGER_EEPROM_PROGRAMDATA_VERSION       53
#define CHEALI_CHARGER_EEPROM_SETTINGS_VERSION          55
