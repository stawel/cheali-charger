...
{string_Vc_per_cell,    COND_Unknown,       BATTERY(V, Vc_per_cell),                {50|CE_HW_LIMITS, ANALOG_VOLT(0.0), MAX_CHARGE_V}},
{string_Vcutoff,        ADV(NiXX),          BATTERY(V, Vc_per_cell),                {CE_STEP_TYPE_KEY_SPEED, ANALOG_VOLT(1.200), ANALOG_VOLT(2.000)}},
{string_Vcutoff,        COND_LED,           BATTERY(V, Vc_per_cell),                {CE_STEP_TYPE_SMART|CE_HW_LIMITS, ANALOG_VOLT(0.001), MAX_CHARGE_V}},
...
{string_Vd_per_cell,    COND_Unknown,       BATTERY(V, Vd_per_cell),                {50|CE_HW_LIMITS, ANALOG_VOLT(0.0), MAX_CHARGE_V}},
{string_capacity,       COND_BATTERY,       BATTERY(CHARGE, capacity),              {CE_STEP_TYPE_SMART, ANALOG_MIN_CHARGE, ANALOG_MAX_CHARGE}},
{string_Ic,             COND_BATTERY+COND_LED, BATTERY(A, Ic),                      {CE_STEP_TYPE_SMART|CE_HW_LIMITS, ANALOG_AMP(0.001), MAX_CHARGE_I}},
{string_minIc,          ADV(LiXX_NiZn_Pb_Unkn), BATTERY(A, minIc),                  {CE_STEP_TYPE_SMART, ANALOG_AMP(0.001), MAX_CHARGE_I}},
{string_Id,             COND_BATTERY,       BATTERY(A, Id),                         {CE_STEP_TYPE_SMART|CE_HW_LIMITS, ANALOG_AMP(0.001), MAX_DISCHARGE_I}},
