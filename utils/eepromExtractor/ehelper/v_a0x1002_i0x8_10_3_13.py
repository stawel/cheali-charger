...
N11ProgramData7Battery3DOT_0E._anonymous_ = ['_1', '_0']
...
CHEALI_CHARGER_EPPROM_VERSION_STRING = '10.3.13' # Variable STRING '(const char*)"10.3.13"'
...
__all__ = ['CHEALI_CHARGER_ARCHITECTURE_INFO',
           ...
           'Vout_plus_pin', 'Lilo', 'Vb8_pin', 'NiCd', 'Vb7_pin',
           'Vb2', 'Vb1', 'NiZn', 'Vb7', 'Textern', 'Vb5',
           'VirtualInputs', 'Vb8', 'deltaTextern', 'CalibrationPoint',
           ...
           'IdischargeSet', 'Pb', 'Iout', 'Life', 'Vb4_pin',
