...
Settings._fields_ = [
    ...
    ('deltaV_NiMH', int16_t),
    ('deltaV_NiCd', int16_t),
    ('cutoffV_NiMH', uint16_t),
    ('cutoffV_NiCd', uint16_t),
    ('DCcycles', uint16_t),
    ('DCRestTime', uint16_t),
    ('audioBeep', uint16_t),
    ('minIoutDiv', uint16_t),
...
CHEALI_CHARGER_EPPROM_VERSION_STRING = '9.2.9' # Variable STRING '(const char*)"9.2.9"'
CHEALI_CHARGER_EEPROM_PROGRAMDATA_VERSION = 2 # Variable c_int '2'
CHEALI_CHARGER_EEPROM_CALIBRATION_VERSION = 9 # Variable c_int '9'
CHEALI_CHARGER_EEPROM_SETTINGS_VERSION = 9 # Variable c_int '9'
__all__ = ['Vout_minus_pin', 'IsmpsSet', 'Calibration',
           ...
           'Vb3_pin', 'Cout', 'VCharge', 'Vin', 'LAST_BATTERY_CLASS',
           'Vb2_pin', 'Vb0_pin',
