...
CHEALI_CHARGER_ARCHITECTURE = 4097 # Variable c_int '4097'
...
CHEALI_CHARGER_EEPROM_SETTINGS_VERSION = 10 # Variable c_int '10'
CHEALI_CHARGER_EEPROM_PROGRAMDATA_VERSION = 3 # Variable c_int '3'
__all__ = ['N11ProgramData7Battery3DOT_03DOT_2E', 'Vout_minus_pin',
