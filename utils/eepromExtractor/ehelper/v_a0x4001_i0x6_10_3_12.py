...
__all__ = ['CHEALI_CHARGER_ARCHITECTURE_INFO',
           ...
           'Vout', 'LAST_BATTERY_TYPE', 'deltaVoutMax', 'Li430',
           'Vbalancer', 'Li435', 'CHEALI_CHARGER_ARCHITECTURE_CPU',
           'Pout', 'CHEALI_CHARGER_ARCHITECTURE', 'deltaVout',
           'Vb1_pin', 'Idischarge', 'MAX_BANANCE_CELLS', 'Data',
           'Vb6_pin', 'N11ProgramData7Battery3DOT_1E', 'NiMH',
           'N11ProgramData7Battery3DOT_13DOT_3E',
           'CHEALI_CHARGER_EEPROM_SETTINGS_VERSION', 'Name',
           'Settings', 'IdischargeSet', 'Iout', 'Life', 'Vb4_pin',
           'CHEALI_CHARGER_EEPROM_PROGRAMDATA_VERSION', 'LastInput',
           'Eout', 'VoutBalancer',
           'CHEALI_CHARGER_ARCHITECTURE_GENERIC', 'Tintern',
           'BatteryType', 'VbalanceInfo',
           'CHEALI_CHARGER_EPPROM_VERSION_STRING', 'Pb', 'VoutMux',
           'Vb3_pin', 'Cout',
           ...
           'NoneBatteryType', 'uint32_t', 'uint8_t', 'uint16_t',
